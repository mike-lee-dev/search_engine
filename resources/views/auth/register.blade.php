            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="password" class="col-md-4 col-form-label text-md-right">{{ __('フォーム登録用パスワード') }}</label>

                            <div class="col-md-6">
                                <input id="form_password" type="password" class="form-control @error('form_password') is-invalid @enderror" name="form_password" required autocomplete="form-password">
                                @error('form_password')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
