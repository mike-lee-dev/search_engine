...
{{--                                    </select>--}}
                                    <select id="sortConditionBean.displayNo" name="displayNo" tabindex="4020" class="mousetrap">
                                        <option value="10" selected>10件表示</option><option value="25">25件表示</option><option value="50">50件表示</option><option value="100">100件表示</option>
                                    </select>
{{--                                    <button class="type-sort button-small button-white nodisabled" id="table_change" name="OAA0103" tabindex="4030">並び替え</button>--}}
                            ...
                            <table class="main-summit-info" id="resultTable">
                                ...
                                <tr>
                                    ...
                                    <th id="requestSubmissionMaterialsBean_th" class="wd-15p th" style="width: 15%;">資料提供招請</th>
                                    <th id="requestCommentBean_th" class="wd-15p th" style="width: 15%;">意見招請</th>
                                    <th id="procurementImplementNoticeBean_th" class="wd-15p th" style="width: 15%;">調達実施案件公示</th>
                                ...
                                @foreach($procurements as $procurement)
                                    <tr>
                                        ...
                                        <td>
                                            <pre></pre>
                                            <a class="koukoku info-button" tabindex="4103" href="{{route('detail', $procurement->id)}}">公示本文</a><br>
