            ...
            <div class="col-12">
                <div class="main-item">
                    ...
                    <dl class="main-item-acodion mt-3">
                        ...
                        <dd class="acodion_content is-close px-0 py-0" style="display: none;">
...
{{--                            </dl>--}}
                            ...
                            <ul class="table-name row mb-0 mx-0">
                                <li class="col-12">
                                    <dl class="table-form">
                                        ...
                                        <dd>
                                            <input name="name" id="name" required="" type="text" size="40"
                                                   maxlength="255" minlength="1">
                                        </dd>
                                    </dl>
                                </li>
                                ...
                                <li class="col-12 px-0 mb-5">
                                    <dl class="table-form">
                                        ...
                                        <dd>
                                            <input type="checkbox">　A　　　　<input type="checkbox">　B　　　<input
                                                type="checkbox">　C　　　　<input type="checkbox">　D
                                            <br>
                                            <input type="checkbox">　ABCD　　<input type="checkbox">　ABC　　<input
                                                type="checkbox">　AB
                                            <br>
                                            <input type="checkbox">　BCD　　　<input type="checkbox">　BC　　　<input
                                                type="checkbox">　CD　　　<input type="checkbox">　等級なし
                                        </dd>
                                    </dl>
                                </li>
                    ...
                    <p class="main-item-txt" id="info04">参照したい調達案件の[公示本文]をクリックすると、調達案件の詳細を確認することができます。<br>また、入札に参加したい案件については、[入札]をクリックすると政府電子調達システム（GEPS）へ遷移し、その案件の入札に参加することができます。
                    </p>
                    <div class="result-detail">
                        ...
                        <table class="main-summit-info" id="resultTable">
                            <thead>
                            <tr>
                                <th id="procurementItemNo_no" class="wd-5p th" style="width: 5%;">ID</th>
                                <th id="procurementItemNo_th" class="wd-14p th" style="width: 14%;">広告公示番号</th>
                                <th id="articleNm_th" class="wd-9p th" style="width: 9%;">調達案件名称</th>
                                <th id="procurementOrgan_th" class="wd-5p th" style="width: 5%;">調達機関</th>
                                <th id="receiptAddress_th" class="wd-5p th" style="width: 5%;">所在地</th>
                                <th id="requestSubmissionMaterialsBean_th" class="wd-15p th" style="width: 15%;">
                                    資料提供招請
                                </th>
                                <th id="requestCommentBean_th" class="wd-15p th" style="width: 15%;">意見招請</th>
                                <th id="procurementImplementNoticeBean_th" class="wd-15p th" style="width: 15%;">
                                    調達実施案件公示
                                </th>
                                <th id="successfulBidNoticeBean_th" class="wd-15p th" style="width: 15%;">落札公示</th>
                            </tr>
                            </thead>
                            <tbody>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            if (searchCon.agency == null) {
                $('#searchCon_agency').text('指定なし');
            } else {
                $('#searchCon_agency').text(searchCon.agency);
            }
            if (searchCon.address == null) {
                $('#searchCon_address').text('指定なし');
            } else {
                $('#searchCon_address').text(searchCon.address);
            }
